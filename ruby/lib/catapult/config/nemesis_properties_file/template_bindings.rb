  ...
  class Config
    class NemesisPropertiesFile
      module TemplateBindings
        XEM_TOTAL_SUPPLY   = "100'000'000"
	XEM_ACCOUNT_SUPPLY = "10'000'000"
        XEM_NUM_OF_ACCOUNTS = 10 # this has to equal ration XEM_TOTAL_SUPPLY/XEM_ACCOUNT_SUPPLY
        ...
        NUM_HARVEST_KEYS       = 1
        HARVEST_ACCOUNT_SUPPLY = "100'000'000'000'000"
        ...
        NUM_CURRENCY_KEYS       = 1 # this has to equal ration XEM_TOTAL_SUPPLY/XEM_ACCOUNT_SUPPLY
